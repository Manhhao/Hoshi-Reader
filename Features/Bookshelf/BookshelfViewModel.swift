...
class BookshelfViewModel {
    ...
    private func syncBook(book: BookMetadata, title: String, bookFolder: String, direction: SyncDirection?, syncStats: Bool, statsSyncMode: StatisticsSyncMode, syncAudioBook: Bool) async throws {
